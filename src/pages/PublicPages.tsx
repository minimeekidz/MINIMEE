...
export function PricingPage() {
  const plans = [
    {
      type: "one_time_theme", emoji: "🎯", icon: <Zap />, title: "單次主題",
      subtitle: "One-time · 單次試試的MiniMEE~", price: "HK$128", priceNote: "單次付款｜帳戶存在期間可保留",
      perks: ["揀1個主題", "1×學習影片＋1×小朋友AI影片＋學習小遊戲", "普通版MEE收藏卡PDF下載"]
    },
    {
      type: "monthly_3m", emoji: "📅", icon: <CalendarDays />, title: "3個月MiniMEE訂閱",
      subtitle: "一次訂閱3個月・每月派發2個主題（每2星期1個）", price: "HK$324", priceNote: "約HK$108／月 · 可隨時停止續訂",
      perks: ["每月2個主題", "每月2×學習影片＋2×小朋友AI影片＋學習小遊戲＋小寵物養成計劃", "朋友紀念冊【10位名額】｜帳戶存在期間可保留", "普通版MEE收藏卡PDF下載", "可加購章節HK$40／1章", "可開啟遺失模式"],
      highlight: true
    },
    {
      type: "yearly", emoji: "👑", icon: <Crown />, title: "1年精明MiniMEE訂閱",
...
const legalDocuments: Record<string, { intro: string; sections: [string, string[]][] }> = {
  "私隱政策": {
    ...
    sections: [
      ...
      ["7. 家長權利與聯絡", ["家長可要求查閱、更正、下載或刪除其本人及孩子的個人資料，亦可撤回非必要同意。部分要求可能需要核實身份，並受法律允許的例外及合理處理安排限制。", "私隱及資料要求請電郵至minimee.kidz@gmail.com。營運者法定名稱及通訊地址須於正式收款前補充。本政策生效日期：2026年7月28日。"]]
    ]
  },
  "服務條款": {
    ...
    sections: [
      ...
      ["2. 方案及派發", ["單次主題HK$128，包括1個主題、1段學習影片、1段孩子AI影片、學習小遊戲及普通版MEE收藏卡PDF。", "3個月預繳HK$324，每月派發2個主題，另包括小寵物養成、10位朋友紀念冊名額、普通版MEE收藏卡PDF、遺失模式及HK$40一章的加購資格。", "全年預繳HK$1,188，每月派發2個主題，另包括小寵物養成、不設名額上限的朋友紀念冊、炫彩版MEE收藏卡PDF、遺失模式、多語言配音及HK$46一章的加購資格。", "所有方案屬每名孩子獨立購買。顯示的每月平均價只供比較，實際在購買時按整個預繳期收費。"]],
      ...
      ["7. 條款變更與適用法律", ["重大變更會以網站、站內訊息或電郵通知。若變更實質影響已付款服務，我們會說明生效時間及可用選項。", "本條款受香港特別行政區法律管限，爭議受香港法院非專屬司法管轄。客服聯絡：minimee.kidz@gmail.com。營運者法定名稱及地址須於正式收款前補充。生效日期：2026年7月28日。"]]
    ]
  },
  "退款與重做政策": {
...
export function LegalPage({ title }: { title: string }) {
  ...
  return <div className="public-page"><PublicHeader /><main className="content-page legal">
    ...
    <aside className="legal-warning"><ShieldCheck /><p>本頁為MINIMEE現行產品規則的營運草案，不構成法律意見；正式收款及處理真實兒童素材前應由香港合資格律師覆核，並補充營運者法定名稱及地址。</p></aside>
