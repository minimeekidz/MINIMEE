...
const legalDocuments: Record<string, { intro: string; sections: [string, string[]][] }> = {
  ...
  "服務條款": {
    ...
    sections: [
      ...
      ["2. 方案及派發", ["單次主題HK$128，包括1個主題、1段學習影片、1段孩子AI影片、學習小遊戲及常規版MEE收藏卡PDF。", "3個月預繳HK$324，每月派發2個主題，另包括小寵物養成、10位朋友紀念冊名額、常規版MEE收藏卡PDF、遺失模式及HK$46一章的加購資格。", "全年預繳HK$1,188，每月派發2個主題，另包括小寵物養成、不設名額上限的朋友紀念冊、炫彩版MEE收藏卡PDF、遺失模式、多語言配音及HK$46一章的加購資格。", "所有方案屬每名孩子獨立購買。顯示的每月平均價只供比較，實際在購買時按整個預繳期收費。"]],
