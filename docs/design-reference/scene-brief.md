...
新圖畫咗戲院、Hero Studio、圖書館、Buddy Café、MEE 珍藏館。
**戲院同圖書館故意冇做門**，因為你講過「Hero Studio…左門去戲院大堂、
右門去圖書館」，而每個室內只有一個「出返去」目標。開多一道街門，
由街入去再出返嚟就會擺你落 Studio，講錯你係邊度入嚟。

**想改嘅話講聲**，我可以改成每間房記住你係邊度入嚟。
