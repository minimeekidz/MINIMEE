...
### 1. 小鎮中心（`小鎮中心_日.webp` / `_夜.webp`）

**最重要嗰張。** 主循環由呢度出發。

| # | 要有咩 | 擺喺 | 備註 |
|---|---|---|---|
| 1 | **戲院大堂** 大門 | 中間偏上 | ⭐ **要最搶眼** —— 有招牌、有海報位、有燈泡邊框。呢度係主循環入口 |
| 2 | Buddy Café 門 | (0.33, 0.26) | 咖啡店，有招牌／杯仔圖案 |
| 3 | Hero Studio 門 | (0.80, 0.42) | 影樓／工作室感覺，有星星招牌 |
| 4 | MEE 珍藏館 門 | (0.68, 0.68) | 博物館感覺，**要夠大夠光**，唔好似地窖 |
| 5 | → 碼頭市集 路口 | (0.79, 0.93) | 右下角，一條落海邊嘅路，有欄杆／碼頭指示牌 |
| 6 | → 小鎮廣場 路口 | (0.46, 0.98) | 底部中間，主路向下 |
